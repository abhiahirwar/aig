            ...
            <footer>
                <div class="container">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="widget">
                                <h5 class="sky-blue-text">{{ strtoupper('Information') }}</h5>
                                <ul>
                        ...
                        <div class="col-md-2">
                            <div class="widget">
                                <h5 class="sky-blue-text">{{ strtoupper('CUSTOMER SERVICE') }}</h5>
                                <ul>
                        ...
                        <div class="col-md-2">
                            <div class="widget">
                                <h5 class="sky-blue-text">{{ strtoupper('IG BLINDS PTY LTD') }}</h5>
                                <p>
