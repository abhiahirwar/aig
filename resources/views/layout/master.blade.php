        ...
        <div id="content" class="no-bottom no-top">
                    ...
                    <ul>
                        <li data-transition="fade" data-slotamount="10" data-masterspeed="200" data-thumb="">
                            ...
                            <div class="tp-caption sfb" data-x="0" data-y="335" data-speed="400" data-start="800" data-easing="easeInOutExpo">
                                <a href="index.html#" class="btn-slider">Our Portfolio
                                </a>
                            </div>
                        </li>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <ul id="filters" class="wow fadeInUp" data-wow-delay="0s">
                                <li><a href="index.html#" data-filter="*" class="selected">All Projects</a></li>
                                <li><a href="index.html#" data-filter=".residential">Residential</a></li>
                                <li><a href="index.html#" data-filter=".hospitaly">Hospitaly</a></li>
                                <li><a href="index.html#" data-filter=".office">Office</a></li>
                                <li><a href="index.html#" data-filter=".commercial">Commercial</a></li>
                            </ul>
            ...
            <footer>
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <img src="images/logo.png" class="logo-small" alt=""><br> We are team based on Brookylin. Our
                        ...
                        <div class="col-md-4">
                            <div class="widget widget_recent_post">
                                <h3>Latest News</h3>
                                <ul>
                                    <li><a href="index.html#">5 Things That Take a Room from Good to Great</a></li>
                                    <li><a href="index.html#">Functional and Stylish Wall-to-Wall Shelves</a></li>
                                    <li><a href="index.html#">9 Unique and Unusual Ways to Display Your TV</a></li>
                                    <li><a href="index.html#">The 5 Secrets to Pulling Off Simple, Minimal Design</a></li>
                                    <li><a href="index.html#">How to Make a Huge Impact With Multiples</a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="widget widget-address">
                                <address>
                                    ...
                                    <span><strong>Web:</strong><a href="index.html#">http://archi-interior.com</a></span>
                                </address>
                            </div>
                        </div>
                    </div>
                ...
                <div class="subfooter">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                &copy; Copyright 2018 - Archi Interior Design Template by <span class="id-color">Designesia</span>
                            </div>
